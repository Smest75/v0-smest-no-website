...
For det som skjer nå, er større enn enda en ny app eller modell. Vi beveger oss fra KI som svarer, til KI som handler. Det høres kanskje ut som en liten nyanse, men i praksis er forskjellen enorm. En chatbot hjelper deg med å tenke, skrive og sparre i en dialog du starter opp. Den fortsetter til du slutter å svare. Så er det ferdig. En agent i en loop kan hjelpe deg med å gjøre, endre seg selv, hente og lage nye verktøy og lære å gjøre mer og mer. Og akkurat der ligger både nytten og faren.
